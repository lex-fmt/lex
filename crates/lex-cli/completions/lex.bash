...
# Generated by clap_complete. SC2034 (`prev` unused) and SC2207
# (compgen splitting in COMPREPLY) are standard patterns in clap-
# generated bash completions; suppressing for the whole file.
_lex() {
